...
| Final del Cuatri | **Entrega 2: *BE (JWT + RBAC + Buenas Practicas) + FE [ Aplicar tecnicas para evitar XSS - No exponer datos sensibles - Validacion de datos (HTML5 o Javasript - Almacenamiento de tokens)]* |
